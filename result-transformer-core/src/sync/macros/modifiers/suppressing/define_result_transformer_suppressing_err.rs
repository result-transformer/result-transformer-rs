#[macro_export]
macro_rules! define_result_transformer_suppressing_err {
    (
        impl_for = $type:ty,
        ...
        result_transformer::core::sync::macros::define_result_transformer_from_err! {
            impl_for = $type,
            input_ok = $input_ok,
            input_err = $input_err,
            output_ok = $output_ok,
...
pub use define_result_transformer_suppressing_err;
