...
macro_rules! define_const_result_noop_step {
    (
        ...
        const $name: result_transformer::flow::sync::step::ResultNoopStep<$ok_type, $err_type> =
            result_transformer::flow::sync::step::ResultNoopStep::new();
    };
    ...
    (
        ...
        result_transformer::flow::sync::macros::define_const_result_noop_step!(
            name = $name,
            ok_type = $ok_type,
            err_type = $err_type
        );
...
pub use define_const_result_noop_step;
