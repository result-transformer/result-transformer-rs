/// Defines a const [`ResultTapBothBindStep`].
///
...
/// - `ok_tap` - Function called with the success value returning `Result`.
/// - `err_tap` - Function called with the error value returning `Result`.
#[macro_export]
